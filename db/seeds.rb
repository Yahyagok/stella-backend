...
a4 = Actor.create(name: "Airicia Reynols", image_url:'Airicia-Reynolds.jpeg',  contact_info: 13474454545, city_id: c2.id, agency_id: agency2.id, description: "She is born in Philedelphia. she is 13 year old. She likes to do gym and sport activities")

a5 = Actor.create(name: "Aoife Jordan", image_url:'Aorife jordan.png',  contact_info: 13403454343, city_id: c3.id, agency_id: agency3.id, description: "She was born in Westminster. she is 20 year old. She look forward to get opportunities as a new actress"  )

a6 = Actor.create(name: "Benito Skinner", image_url: 'Benite-Skinner.jpg',  contact_info: 443453432, city_id: c4.id, agency_id: agency2.id, description: "Benito Skinner, also known as Benny Drama, writes and produces the kind of parody videos that will have you cackling over your phone in your bedroom in the middle of the night. From skits like “Lizzie McGuire is BACK!” and “The *REAL* Dumbledore” to his reads on what it’s like to date each zodiac sign, Skinner brings full commitment to his comedy. As the name suggests, drama is his forte.
